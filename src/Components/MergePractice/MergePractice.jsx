...
function MergePractice() {
  ...
  return (
    <main className="mx-auto max-w-3xl rounded-xl bg-white p-6 shadow-sm sm:p-10">
      ...
      <div className="border-t border-gray-200 pt-6">
        <p className="mb-4 text-gray-700">
          This is a real page in the YouTube Clone. Create a branch, change the
          message above, and ask your friend to change the same line in a
          different way.
        </p>
        <button
          type="button"
